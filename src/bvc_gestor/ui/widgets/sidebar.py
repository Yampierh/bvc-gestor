...
class SidebarWidget(QFrame):
    ...
    def init_ui(self):
        ...
        self.btn_inversores = self.create_button("src/bvc_gestor/assets/icons/groups.svg", "Inversores", 1, "Inversores")
        self.btn_operaciones = self.create_button("src/bvc_gestor/assets/icons/attach_money.svg", "Operaciones", 2, "Operaciones")
        ...
        layout.addWidget(self.btn_inversores)
        ...
        self.buttons = [self.btn_home, self.btn_inversores, self.btn_operaciones, self.btn_transacciones, self.btn_config]
